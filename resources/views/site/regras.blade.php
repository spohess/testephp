<div class="col-12 mt-5">
    ...
    <h3 class="mt-5 text-primary">1 - Seleção de tropa</h3>
    ...
    <h3 class="mt-5 text-primary">3 - Contagem de pontos</h3>
    <ul class="list-unstyled">
        <li>
            <p><strong>3.1 - </strong> Serão somadas todas as habilidades do personagem com a arma que ele estiver usando;</p>
        </li>
        <li>
            <p><strong>3.2 - </strong> As pontuações das armas serão aleatórias respeitando o mínimo e o máximo da tabela de pontuação;</p>
        </li>
        <li>
            <p><strong>3.3 - </strong> Armas que não atenderem o item 2.1 não terão seus pontos somados;</p>
        </li>
        <li>
            <p><strong>3.4 - </strong> Os pontos do Olho De Sauron só serão somados a tropa de orcs se na tropa da sociedade tiver o Frodo usando o Um Anel como arma;</p>
        </li>
    </ul>

    <h3 class="mt-5 text-primary">4 - Desenvolvimento</h3>
    <ul class="list-unstyled">
        <li>
